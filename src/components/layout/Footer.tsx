...
const cols = [
  ...
  },
  {
    title: "Pedidos",
    links: [
      { label: "En mesa", href: "#features" },
      { label: "Para llevar", href: "#features" },
      { label: "Delivery a domicilio", href: "#features" },
      { label: "Seguimiento", href: "#how-it-works" },
    ],
  },
  {
    title: "App",
    links: [
      { label: "Descargar en iOS", href: "#download" },
      { label: "Descargar en Android", href: "#download" },
      { label: "Panel de cocina", href: "#admin" },
    ],
  },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-sm leading-relaxed max-w-xs text-white/50">
              La app oficial para pedir arepas venezolanas. Personaliza, paga y
