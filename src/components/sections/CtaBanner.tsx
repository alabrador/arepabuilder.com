  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
        ...
        >
          ¿Listo para pedir{" "}
          <span className="text-gradient-gold">tu primera arepa?</span>
        </h2>

        <p className="text-lg text-white/50 mb-12 max-w-xl mx-auto">
          Descarga la app gratis, personaliza tu pedido en segundos y recíbelo
          donde quieras. Tu sabor venezolano, en tiempo real.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
          ...
          >
            ...
            <div className="text-left">
              <p className="text-[10px] font-medium text-[#2E1600]/50 uppercase tracking-wider">Disponible en</p>
          ...
          >
            ...
            <div className="text-left">
              <p className="text-[10px] font-medium text-white/40 uppercase tracking-wider">Disponible en</p>
