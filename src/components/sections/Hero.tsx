  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-32 -right-32 w-[600px] h-[600px] rounded-full bg-[#FFD95A]/5 blur-3xl" />
        <div className="absolute -bottom-48 -left-48 w-[700px] h-[700px] rounded-full bg-[#FFC400]/8 blur-3xl" />
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="flex flex-col items-start">
            ...
            <div className="flex items-center gap-2 mb-5 sm:mb-6">
              <span className="inline-flex items-center gap-1.5 bg-[#FFC400]/15 border border-[#FFC400]/25 text-[#FFC400] text-[10px] sm:text-xs font-semibold uppercase tracking-widest px-3 sm:px-4 py-1.5 rounded-full">
            ...
            <div className="flex flex-col xs:flex-row flex-wrap gap-3 sm:gap-4 mb-8 sm:mb-10 w-full xs:w-auto">
              <a
                href="#download"
                className="group flex items-center justify-center gap-3 bg-gradient-to-br from-[#FFD95A] via-[#FFC400] to-[#E9A900] hover:brightness-[1.05] text-[#03265B] font-bold px-6 sm:px-7 py-3.5 sm:py-4 rounded-2xl transition-all duration-200 shadow-[0_8px_30px_rgba(233,169,0,0.4)] hover:shadow-[0_8px_36px_rgba(233,169,0,0.55)] hover:-translate-y-0.5"
              >
          ...
          <div className="flex justify-center lg:justify-end items-center relative mt-6 lg:mt-0">
            ...
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div className="w-60 h-60 sm:w-72 sm:h-72 rounded-full bg-[#FFC400]/20 blur-3xl" />
            </div>
            ...
            <div className="relative animate-float">
              ...
              <div className="hidden sm:block absolute -top-4 -right-10 z-10 glass-dark rounded-2xl px-4 py-3 min-w-[175px] shadow-gold animate-float-reverse">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-xl bg-[#27864A]/20 flex items-center justify-center text-base flex-shrink-0">
                    🔔
                  </div>
                  <div>
              ...
              <div className="hidden sm:block absolute -bottom-6 -left-10 z-10 glass-dark rounded-2xl px-4 py-3 min-w-[165px] shadow-brand animate-float">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-xl bg-[#FFC400]/25 flex items-center justify-center text-base flex-shrink-0">
                    💳
                  </div>
                  <div>
                    <p className="text-white text-xs font-semibold">Cobro procesado</p>
                    <p className="text-[#27864A] text-[10px] font-medium">✓ Stripe · Sin comisión</p>
                  </div>
                </div>
              </div>
              ...
              <div className="sm:hidden absolute -bottom-3 left-1/2 -translate-x-1/2 z-10 glass-dark rounded-full px-4 py-2 whitespace-nowrap">
                <p className="text-[10px] text-[#27864A] font-semibold flex items-center gap-1.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#27864A] animate-pulse inline-block" />
