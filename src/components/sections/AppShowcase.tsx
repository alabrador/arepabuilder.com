...
function Pill({ icon, text }: { icon: string; text: string }) {
  return (
    <li className="flex items-center gap-2.5 text-sm text-white/65">
      <span className="w-6 h-6 rounded-lg bg-[#FFC400]/15 border border-[#FFC400]/25 flex items-center justify-center flex-shrink-0 text-sm">
        {icon}
      </span>
      {text}
    </li>
...
export default function AppShowcase() {
  return (
    <section
      id="app"
      className="bg-[#03265B] overflow-hidden"
    ...
    >
      ...
      <div className="relative py-16 md:py-24">
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="w-[700px] h-[400px] rounded-full bg-[#FFC400]/12 blur-3xl" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            {/* Copy — left */}
            <div>
              <span className="inline-block text-xs font-bold uppercase tracking-[0.2em] text-[#FFC400] mb-5">
              ...
              <a
                href="#download"
                className="inline-flex items-center gap-3 bg-[#FFC400] hover:bg-[#FFD95A] text-[#03265B] font-bold px-6 sm:px-7 py-3.5 sm:py-4 rounded-xl transition-all duration-200 hover:-translate-y-0.5 shadow-gold"
              >
              ...
              <div className="flex lg:hidden justify-center">
                <div className="relative">
                  <Phone
                    ...
                    width={210}
                    priority
                    className="ring-[#FFC400]/40 shadow-gold"
                  />
                  {/* Mini badge */}
                  <div className="absolute -top-3 -right-3 bg-[#FFC400] text-[#03265B] text-[10px] font-black px-2.5 py-1 rounded-full shadow-lg">
                    App Demo
                  </div>
                </div>
              </div>
